...
def gamma(shape, alpha, dtype=None, seed=None):
    ...
    # Handle alpha < 1: Gamma(alpha) = Gamma(1+alpha) * U^(1/alpha)
    ...
    # Unrolled rejection sampling loop
    num_iters = 10
